      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="max-w-xl mx-auto font-sans text-xs sm:text-sm text-gray-400 tracking-wider">
            We operate the most comprehensive premium health and physical development lab in Kandari, Shanti Nagar, and the surrounding regions.
          </p>
        </div>

        {/* Feature Blocks Stack */}
        <div className="space-y-6" id="why-us-stack">
